...
import os
token = '7241275504:AAHPTYmsINHBZ5pbpAp6h6DA9NY6mmH4F2U'
bot=telebot.TeleBot(token,parse_mode="HTML")
subscriber = '6510459037'
@bot.message_handler(commands=["start"])
def start(message):
	if not str(message.chat.id) == '6510459037':
		bot.reply_to(message, "You cannot use the bot to contact developers to purchase a bot subscription @call_me_naoki")
		return
...
𝒃𝒚 ➜ @call_me_naoki ''', reply_markup=mes)
				msg = f'''{cc}
Payment successful ✅'''
				print(last)
